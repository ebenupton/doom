; crtc_probe.s — standalone CRTC display-start probe.
;
...
; ca65 since 2026-09-05 (converted from beebasm; ORG/SAVE are now
; src/boot/cfg/crtc_probe.cfg).
...
; ORG $1900 -> the linker config
start:
    LDA #22
    JSR $FFEE
    LDA #4
    JSR $FFEE                                   ; MODE 4 (OS sets its own
