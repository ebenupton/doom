...
HAMILTONIAN_12 = 1
.if ::FLATORG
STEEP_COMPACT = 1   ; flat: compact loops (blob must fit $7500-
; $7FFF; steep is ~1% of suite pixels)
.else
STEEP_COMPACT = 0   ; banked: unrolled steep restored 2026-08-11
...
.if ::FLATORG
; SAVE "linedraw_or_flat.bin", &7500, P% -> the build script
.else
; SAVE "linedraw_or_reloc.bin", &A200, P% -> the build script
.endif
