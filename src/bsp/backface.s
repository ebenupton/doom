...
sl_rts:                                    ; seg count exhausted (moved with
   RTS                                     ; the pair, 2026-09-05)
...
; FALLS INTO back_face_test (2026-09-05): this pair moved here from
; subsector.s so the seg loop is laid out in execution order —
; s_advance_l0 falls into seg_proc falls into the test, and the 65.9 JMPs
; a frame that last edge cost are gone (tools/jump_census.py).
