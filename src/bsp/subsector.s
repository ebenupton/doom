...
ch_v1_done_l0:
; (the v1-key banking block died 2026-07-25: vertex spans serve at
; FIRST TRANSFORM inside br_seg_xform_vertex — no emit-time replay of
; v1's key, so nothing needs it after the v2 transform overwrites)
...
; (vertex-span emission moved to vs_serve in seg_xform.s, 2026-07-25:
; SERVE AT FIRST TRANSFORM — the vc-miss tail serves each vertex once
; per frame; the emit-cascade probe sites and the VDONE bitmap died.)
