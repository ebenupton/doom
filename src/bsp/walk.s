...
; ============================================================================
; APPENDIX (comment only): the backed-out 2026-07-15 walk rewrite.
; This is the alternate implementation from commit b816802 (reverted in
; 41bdb29 at Eben's request) — the "mirror the pseudocode" restructure
; with the stack-based control flow. Preserved here verbatim for
; reference; the live implementation above is the b7f71ff form. If it
; is ever revived, land it as its OWN commit and re-measure.
; ============================================================================
;
; ; ============================================================================
; ; br_render_frame — top-level entry. Walks the BSP from the root,
