...
def main():
    ...
    # sqr quad: boot-GENERATED by anim_init on hardware; mirrored from the
    # model here since this rig enters entries directly (see test_lockstep)
    ...
    def run(entry):
        mpu=sc.mpu; mpu.pc=entry; mpu.sp=0xDD; mpu.p=0x34
        bare[0x01DF]=0xFE; bare[0x01DE]=0xFF
