...
def gen_engine_syms():
    ...
    entries = [('ENG_VIEW_SETUP',   'view_setup',  'PAGE BANK_L0 first'),
               ...
               ('ENG_PMOVE_SLIDE',  'pmove_slide',    'P_HitSlideLine: A=move dir, out pm_sdx/y'),
               ('ENG_PM_SDX',       'pm_sdx',         'slide delta out (sdy = +2)'),
               ('ENG_PMOVE_APPLY',  'pmove_apply',    'position += slide vector'),
               ('ENG_PMOVE_UNAPPLY','pmove_unapply',  'position -= slide vector'),
               ('ENG_PMOVE_TRY_SLIDE','pmove_try_slide','slide retry: A=move dir, applies on C=1')]
