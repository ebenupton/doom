...
### Frame-Global View Cache (`vxcache`)
...
With frame-global vxcache + ycache, shared vertices (appearing in 2-3 segs) pay the full cost once. Typical savings: 30-50% of total V+P muls.
