...
def render(px,py,ab,angle):  # angle: False=corner, True=hybrid(exact, current in fp_bbox)
...
t=render(px,py,ab,False)            # corner truth
h=render(px,py,ab,True)             # EXACT hybrid (currently in fp_bbox_visible_fixed)
print(f"(973,-3367,239): EXACT hybrid vs corner disp={disp(h,t)}  (lean was 99)")
