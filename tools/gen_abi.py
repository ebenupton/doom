...
ABI = [
    ...
    ('BCA_AB',         0x62,   None, 'view angle byte — ZP (zp_buf\'s slot, freed with span_read 2026-07-26; NOT $64 — that is zp_bv_entry\'s HI byte, the drivers seed it); poked per frame by driver/harness; vrcache_ab aliases it; zp.inc aliases bca_ab = BCA_AB'),
