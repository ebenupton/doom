...
ABI = [
    ...
    ('ENGINE_JT',      0x2C00, 0x4800, 'driver-facing jump table = MAIN segment head (link-asserted)'),
    ('JT_VIEW_SETUP',  'ENGINE_JT+$09', None, 'br_view_setup'),
    ('JT_RENDER_FRAME','ENGINE_JT+$15', None, 'br_render_frame'),
    ('JT_INIT_FRAME',  'ENGINE_JT+$1B', None, 'br_init_frame'),
    ('JT_ANIM_TICK',   'ENGINE_JT+$1E', None, 'anim_tick (PAGE BANK_L2 first)'),
    ('JT_ANIM_INIT',   'ENGINE_JT+$21', None, 'anim_init (PAGE BANK_L2 first)'),
    ...
    ('RCACHE_STATE',   0xB460, 0x3F60, 'rotation cache header+bitmaps (RCACHE+$760)'),
    ('RCACHE_STATE_LEN',0x89,  None, 'bytes to zero at boot'),
    ('RCACHE_ENABLE',  0xB4E8, 0x3FE8, 'rotation-coherence bca cache switch (RCACHE+$7E8)'),
    ('STK_STAGE',      0xA100, None, 'RNS vectoring block staged in L2 (page 1 unloadable)'),
    ('STK_DST',        0x0100, None, 'stack-page home of the RNS block'),
    ('STK_LEN',        0xC0,   None, 'RNS block length'),
