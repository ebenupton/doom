...
ABI = [
    ...
    ('PM_MOMX',        0x17F8, None,   'player momentum x (s16 8.8 prescaled) — the COLPORT tail; ships as LOW-image zeros (the copy-down that used to zero-seed it is gone)'),
    ...
    ('PM_TICREM',      0x17FC, None,   '35Hz tic accumulator remainder — DEAD since single-step momentum; declared for pm_fuzz'),
