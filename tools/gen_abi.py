...
ABI = [
    ...
    ('VXCACHE_STATE',      0x0900, None, 'THE BITMAP PAGE: VRCACHE_VALID+VDONE+VXCACHE_VALID (boot zeroes the whole page; the 59 B RCACHE_COMPUTED bitmap went with the extent cache 2026-09-04)'),
