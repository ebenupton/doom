...
ABI = [
    ...
    ('COLIDX_BASE',    0xAB00, 0x7600, 'collision blockmap: 36 x (u16 list addr, u8 count) + the u8 lists (banked moved off the $B400 SSMASK staging page 2026-08-15 — the 256B mask copy-down was dragging COLIDX bytes into ANIM_SSMASK 164-220)'),
