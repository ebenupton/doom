...
.drv
    ...
    LDA #&80:STA &1B6F                              ; bca_ab (BCA_WS+$2F)
...
.stkcpy
    ...
    LDA #4 :STA &FE30 : JSR &2C09                   ; br_view_setup (pages L0/L2)
...
.clr
    ...
    LDA #4 :STA &FE30
    JSR &2C1B                                       ; br_init_frame
    JSR &2C15                                       ; br_render_frame
.spin
    JMP spin
.drv_end
SAVE "DRV", &2000, drv_end, &2000
