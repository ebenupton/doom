...
VXC_STATE = 0x0700  # RCACHE_COMPUTED only since 2026-08-13 (the other bitmaps ride the VXC plane tails at $13C7/$15C7/$17C7; $073B-$07FF free; boot still zeroes the page)
