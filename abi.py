...
DRV_CLR = 0x2200  # input block; the unrolled framebuffer clears moved to BANK C 2026-08-16 (2026-08-14: the sincos overlay moved to bank A $BA00 with STEPTAB/USEVEC; the driver packs below the engine PMOVE slice at $2600)
