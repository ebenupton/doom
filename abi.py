...
RCACHE_STATE_FLAT = 0x3F60
RCACHE_STATE_LEN = 0x0089  # bytes to zero at boot
RCACHE_ENABLE = 0xB4E8  # rotation-coherence bca cache switch (RCACHE+$7E8)
RCACHE_ENABLE_FLAT = 0x3FE8
STK_STAGE = 0xA100  # RNS vectoring block staged in L2 (page 1 unloadable)
STK_DST = 0x0100  # stack-page home of the RNS block
STK_LEN = 0x00C0  # RNS block length
