...
CPM_BASE = 0x8E00  # corner-phi memo: 128-slot xor hash, 3.5 pages ending EXACTLY at $5800 flat (banked: L2 window gap after VATOX; flat: CODE-tail BSS carve, link-asserted)
CPM_BASE_FLAT = 0x5480
CPM_KDXL = 0x8E00  # memo key: corner dx lo
CPM_KDXH = 0x8E80  # ... dx hi
CPM_KDYL = 0x8F00  # ... dy lo
