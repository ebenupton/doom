...
OV={'pillar':(83.2,410.0),'barrel':(41.0,126.0),'lamp':(41.0,152.0),
    'potion':(41.0,128.0),'helmet':(41.0,128.0),'stim':(24.0,30.0),
    'medikit':(35.7,58.3),'armour':(41.0,128.0)}
NOTE={'pillar':'the viewpoint ELECA0 implies',
      ...
      'stim':'the viewpoint STIMA0\'s lid implies (taper + depth solve to eye 24, D 30)',
      'medikit':'the viewpoint MEDIA0\'s lid implies (eye 35.7, D 58)',
